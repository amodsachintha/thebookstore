...
<link rel='icon' type='image/png' sizes='16x16' href='siteImg/favicon-16x16.png'>
	...
	echo "<table align='center' cellpadding='8' cellspacing='60';>
		<tr align='center'>
			<td><u>user id</u></td>
			<td><u>user name</u></td>
			<td><u>email</u></td>
		...
		$q = "select user.uid,user.username,user.email,user.phone,profileImg from store.user;";
		...
		if(empty($runQ)){
			...
			echo "<table align='center' cellpadding='8' cellspacing='20';>
					<tr align='center'>
						...
						<img src='user_images/profile_images/$pic' width='100px' height='auto'>
					</tr>
					</table>
					<hr>
				";
